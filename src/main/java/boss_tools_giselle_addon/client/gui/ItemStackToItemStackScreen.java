...
public class ItemStackToItemStackScreen<T extends ItemStackToItemStackContainer<?>> extends ContainerScreen<T>
{
	...
	public void render(MatrixStack matrix, int mouseX, int mouseY, float partialTicks)
	{
		...
		ItemStackToItemStackTileEntity tileEntity = this.menu.getTileEntity();
