...
public class ThrowOnOrbitTrigger extends AbstractCriterionTrigger<ThrowOnOrbitTrigger.Instance>
{
	...
	public ThrowOnOrbitTrigger.Instance createInstance(JsonObject json, EntityPredicate.AndPredicate and, ConditionArrayParser parser)
	{
		ItemPredicate item = ItemPredicate.fromJson(json.get("item"));
		return new ThrowOnOrbitTrigger.Instance(and, item);
	}
