...
public class AddonBlocks
{
	...
	public static final RegistryObject<AdvancedCompressorBlock> ADVANCED_COMPRESSOR = BLOCKS.register("advanced_compressor", () -> new AdvancedCompressorBlock(Block.Properties.of(Material.METAL)));
