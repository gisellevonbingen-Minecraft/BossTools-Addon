...
public class PlayerCreateSpaceStationTrigger extends AbstractCriterionTrigger<PlayerCreateSpaceStationTrigger.Instance>
{
	...
	public PlayerCreateSpaceStationTrigger.Instance createInstance(JsonObject json, EntityPredicate.AndPredicate player, ConditionArrayParser parser)
	{
		RegistryKey<World> at = json.has("at") ? RegistryKey.create(Registry.DIMENSION_REGISTRY, new ResourceLocation(JSONUtils.getAsString(json, "at"))) : null;
