...
import astrocraft_giselle_addon.common.block.entity.AdvancedCompressorBlockEntity;
import astrocraft_giselle_addon.common.block.entity.AdvancedCompressorBlockEntity.ICompressorMode;
...
import astrocraft_giselle_addon.common.network.AdvancedCompressorMessageMode;
...
public class AdvancedCompressorScreen extends ItemStackToItemStackScreen<AdvancedCompressorContainerMenu>
{
	...
	public void render(PoseStack stack, int mouseX, int mouseY, float partialTicks)
	{
		...
		if (this.getChangeModeButton().isHoveredOrFocused() == true)
		{
			...
			this.renderTooltip(stack, new TranslatableComponent(this.rtl("change." + text), cyclicMode.getText()), mouseX, mouseY);
		}
