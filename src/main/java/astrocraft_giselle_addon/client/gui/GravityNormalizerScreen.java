...
import astrocraft_giselle_addon.common.network.GravityNormalizerMessageRange;
import astrocraft_giselle_addon.common.network.GravityNormalizerMessageWorkingAreaVisible;
...
public class GravityNormalizerScreen extends AbstractMachineScreen<GravityNormalizerContainerMenu>
{
	...
	public void setWorkingAreaVisible(boolean visible)
	{
		...
		AddonNetwork.CHANNEL.sendToServer(new GravityNormalizerMessageWorkingAreaVisible(this.getMenu().getBlockEntity(), visible));
	}
	...
	public void onWorkingAreaUpButtonClick(Button button)
	{
		...
		AddonNetwork.CHANNEL.sendToServer(new GravityNormalizerMessageRange(blockEntity, nextRange));
	}
