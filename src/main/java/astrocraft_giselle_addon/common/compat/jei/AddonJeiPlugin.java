...
import astrocraft_giselle_addon.common.item.crafting.AddonRecipes;
import astrocraft_giselle_addon.common.item.crafting.ExtrudingRecipe;
import astrocraft_giselle_addon.common.item.crafting.RollingRecipe;
...
import net.mrscauthd.astrocraft.crafting.BlastingRecipe;
import net.mrscauthd.astrocraft.crafting.CompressingRecipe;
...
import net.mrscauthd.astrocraft.jei.JeiPlugin.CompressorJeiCategory;
...
public class AddonJeiPlugin implements IModPlugin
{
	...
	public AddonJeiPlugin()
	{
		...
		this.electricBlastFurnace.getCategories().add(Pair.of(BlastingFurnaceJeiCategory.Uid, BlastingRecipe.class));
		...
		this.advancedCompressor.getCategories().add(Pair.of(CompressorJeiCategory.Uid, CompressingRecipe.class));
		this.advancedCompressor.getCategories().add(Pair.of(this.getRollingCategory().getUid(), RollingRecipe.class));
		this.advancedCompressor.getCategories().add(Pair.of(this.getExtrudingCategory().getUid(), ExtrudingRecipe.class));
