...
import astrocraft_giselle_addon.common.util.NBTUtils;
...
import net.mrscauthd.astrocraft.capability.IOxygenStorageHolder;

public class OxygenCanCapabilityProvider implements ICapabilityProvider, IOxygenStorageHolder
{
	public static final String KEY_NBT = AstroCraftAddon.rl("oxygen_capacitor_capability").toString();
