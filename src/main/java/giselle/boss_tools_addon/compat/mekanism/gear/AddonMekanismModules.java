...
import giselle.boss_tools_addon.compat.mekanism.api.text.StringLangEntry;
import giselle.boss_tools_addon.compat.mekanism.gear.mekasuit.ModuleSpaceBreathingUnit;
import giselle.boss_tools_addon.compat.mekanism.gear.mekasuit.ModuleSpaceFireProofUnit;
import giselle.boss_tools_addon.compat.mekanism.gear.mekasuit.ModuleVenusAcidProofUnit;
...
public class AddonMekanismModules
{
	...
	public static final ModuleData<ModuleVenusAcidProofUnit> GRAVITY_NORMALIZING_UNIT;
	...
	static
	{
		...
		GRAVITY_NORMALIZING_UNIT = register("gravity_normalizing_unit", ModuleVenusAcidProofUnit::new).rarity(Rarity.UNCOMMON);
